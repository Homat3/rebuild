...
public class NPU
{
    ...
    /*
    // Creates a new BlockItem with the id "npu:example_block", combining the namespace and path
    ...
    // Creates a new food item with the id "npu:example_id", nutrition 1 and saturation 2
    ...
    // Creates a creative tab with the id "npu:example_tab" for the example item, that is placed after the combat tab
